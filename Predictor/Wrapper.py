...
from aipodMain.utilities.helper_data_encapsulation import OutputFaceData
class FaceDetectionRecognition():
    ...
    def __init__(self,image_data,
        ...
        self.thread_detector = FacePredictor(FACE_DETECTOR_SSD_LABEL_PATH,
                                    image_data,
                                    self.output_data.detection_data,
                                    detector_thresh,
                                     IMG_SCALE = DETECTOR_IMG_SCALE,
                                    TRACKER_TYPE = detection_tracker)
