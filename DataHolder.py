import numpy as np
class OutputFaceData:
    def __init__(self):
        self.detection_data = self.OutputFaceDetectionData()
        self.recognition_data = self.OutputFaceRecognitionData()

    class OutputFaceRecognitionData():
        def __init__(self):
